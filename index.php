...
if(isset($_POST['submit'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO emp_data(u_card, u_f_name, u_l_name, u_father, u_aadhar, u_birthday, u_gender, u_email, u_phone, u_state, u_dist, u_village, u_education, u_pincode, u_mother, u_family, staff_id,image,uploaded) VALUES ('$u_card','$u_f_name','$u_l_name','$u_father','$u_aadhar','$u_birthday','$u_gender','$u_email','$u_phone','$u_state','$u_dist','$u_village','$u_education','$u_pincode','$u_mother','$u_family','$u_staff_id','$image',NOW())";
	...
	if($added){
		echo "
			<div class='btn-success' style='padding: 15px; text-align:center;'>
				Your Employee Data has been Successfully Added.
			</div><br>
		";
	}
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
				...
				<th class="text-center" scope="col">Emp Id.</th>
        	...
        	$get_data = "SELECT * FROM emp_data order by 1 desc";
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="C:\xampp\htdocs\emp\upload_images\CB.PNG" width="300px" height="80px" alt=""></center>
...
<input type="text" class="form-control" name="card_no" placeholder="Enter 12-digit EMP Id." maxlength="12" required>
</div>
<div class="form-group col-md-6">
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<i class='fa fa-home' aria-hidden='true'> Address : </i> $village, $education, <br> $dist, $state - $pincode
						<br />
						</p>
						<!-- Split button -->
					</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<input type='text' class='form-control' name='card_no' placeholder='Enter 12-digit EMP Id.' maxlength='12' value='$card' required>
		</div>
		<div class='form-group col-md-6'>
		<label for='inputPassword4'>Mobile No.</label>
		...
		<div class='form-group'>
		<label for='inputAddress2'>education</label>
		<input type='text' class='form-control' name='education' placeholder='Enter education' value='$education'>
		</div>
		<div class='form-row'>
		<div class='form-group col-md-6'>
		<label for='inputCity'>District</label>
